...
void clock_animation_sword(player_t *player)
{
    ...
    if (player->c_sword->seconds > 0.04 && player->attack == true && player->weapon == 1) {
...
void clock_animation_spear(player_t *player)
{
    ...
    if (player->c_spear->seconds > 0.08 && player->attack == true  && player->weapon == 2) {
...
void clock_animation_punch(player_t *player)
{
    ...
    if (player->c_punch->seconds > 0.08 && player->attack == true && player->weapon == 3) {
...
void clock_animation_gun(player_t *player)
{
    ...
    if (player->c_gun->seconds > 0.08 && player->attack == true && player->weapon == 4) {
